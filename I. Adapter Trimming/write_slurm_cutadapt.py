...
if __name__ == "__main__":
   parser = argparse.ArgumentParser(
      description = "Writes SBATCH script for adapter trimming."
   )
   parser.add_argument(
      "--input_folder", 
      help = "Name of folder containing all raw FASTQs (do not incl. directory)", 
      required = True
   )
   parser.add_argument(
      "--output_folder", 
      help = "Name of output folder for trimmed reads "
      "(after running run_cutadapt_fastp)", 
      required = True
   )
   parser.add_argument(
      "--email", 
